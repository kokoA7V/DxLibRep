...
void Player::DispHands(int posX) {
	...
	for (int i = 0; i < nowHands; i++)
	{
		...
		if (setHand == i)
		{
			DrawFormatString(i * 100 + 50 + posX, 600, GetColor(255, 0, 0), "攻撃力 %d", hands[i]);
			DrawFormatString(i * 100 + 50 + posX, 650, GetColor(255, 0, 0), "番号 %d", i);
		}
		else
		{
			DrawFormatString(i * 100 + 50 + posX, 600, GetColor(255, 255, 255), "攻撃力 %d", hands[i]);
			DrawFormatString(i * 100 + 50 + posX, 650, GetColor(255, 255, 255), "番号 %d", i);
		}
	}
}
